# Error states for invalid variant combinations
...
**Error states for invalid variant combinations**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
