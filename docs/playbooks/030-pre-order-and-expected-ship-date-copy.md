# Pre-order and expected ship date copy
...
**Pre-order and expected ship date copy**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
