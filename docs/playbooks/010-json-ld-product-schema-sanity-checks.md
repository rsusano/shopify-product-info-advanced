# JSON-LD Product schema sanity checks
...
**JSON-LD Product schema sanity checks**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
