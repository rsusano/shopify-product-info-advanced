# One-time vs subscription default selection ethics
...
**One-time vs subscription default selection ethics**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
