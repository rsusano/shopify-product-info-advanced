# CDN URLs and asset_url best practices
...
**CDN URLs and asset_url best practices**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
