# Safari and iOS form quirks with selling plans
...
**Safari and iOS form quirks with selling plans**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
