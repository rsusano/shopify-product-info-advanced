# Selling plan group naming in Theme Editor
...
**Selling plan group naming in Theme Editor**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
