# Loading states for dynamic price updates
...
**Loading states for dynamic price updates**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
