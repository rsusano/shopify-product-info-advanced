# Shipping and returns copy near the buy box
...
**Shipping and returns copy near the buy box**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
