# Color contrast for badges and sale labels
...
**Color contrast for badges and sale labels**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
