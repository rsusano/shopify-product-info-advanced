# Above-the-fold content and Core Web Vitals
...
**Above-the-fold content and Core Web Vitals**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
