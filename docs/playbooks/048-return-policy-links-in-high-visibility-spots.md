# Return policy links in high-visibility spots
...
**Return policy links in high-visibility spots**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
