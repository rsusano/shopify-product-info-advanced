# Announcement bar vs product section messaging hierarchy
...
**Announcement bar vs product section messaging hierarchy**: translate the checklist below into concrete Theme Editor choices, metafields, and section blocks so the PDP story stays consistent from ad click to order confirmation.
